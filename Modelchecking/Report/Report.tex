...
%
% House rule: no em dashes anywhere, in text or in code comments. In
% LaTeX an em dash is written as three hyphens, so do not use "---".
% =====================================================================
...
\author{Gabriella \todo{surname} \\ \todo{student number}}
\date{\today}
